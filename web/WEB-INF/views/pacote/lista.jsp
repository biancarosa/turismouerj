    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${pacotes}" var="pacote">
            <tr>
                ...
                <td><a href='/venda/criar?pacoteId=${pacote.getCodigo()}'>Vender pacote</a></td>
                <td><a href='/pacote/remover?pacoteId=${pacote.getCodigo()}'>Remover pacote</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
